...
* Contenedor para una moneda animada 3D (Cara/Cruz) y una línea de tiempo visual (burbujas) con los últimos resultados.
* Controles de Apuesta: Selector de cantidad manual funcional (campo de entrada numérico sincronizado) con botones +/- para ajustes rápidos (múltiplos de 10), selección de "Cara" o "Cruz".
...
* **Lógica al Lanzar:** Validar apuesta manual con el Wallet, restar fichas, ejecutar animación 3D sincronizada con los estados de la moneda, aplicar ganancias (1:1 si acierta) y actualizar el DOM.
* **Sincronización:** El input de apuesta debe permitir entrada manual y responder a los botones +/- de forma reactiva.
* **Explicación del Mito:** Al llegar a 15 lanzamientos o tras una simulación batch, mostrar dinámicamente la explicación de que "la moneda no tiene memoria".
